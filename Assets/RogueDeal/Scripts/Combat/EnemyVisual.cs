...
namespace RogueDeal.Combat
{
    public class EnemyVisual : MonoBehaviour
    {
        ...
        public void UpdateHealthBar(bool animate = true)
        {
            ...
            float healthPercent = (float)enemyInstance.stats.currentHealth / enemyInstance.stats.maxHealth;
            ...
            if (healthText != null)
            {
                healthText.text = $"{enemyInstance.stats.currentHealth} / {enemyInstance.stats.maxHealth}";
            }
            
            if (enemyHealthBar != null)
            {
                enemyHealthBar.UpdateHealthBar(enemyInstance.stats.currentHealth, enemyInstance.stats.maxHealth, animate);
            }
        }
