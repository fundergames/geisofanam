...
namespace RogueDeal.Editor
{
    ...
    {
        private const string CONTROLLER_PATH = "Assets/RogueDeal/Combat/Animations/AC_Polygon_Combat.controller";
        private const string POLYGON_ANIM_BASE = "Assets/Synty/AnimationBaseLocomotion";
        private const string THIRDPERSON_ANIM = "Assets/RogueDeal/Combat/Animations";
