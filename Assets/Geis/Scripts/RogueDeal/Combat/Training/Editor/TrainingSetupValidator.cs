...
namespace RogueDeal.Combat.Training.Editor
{
    ...
    public class TrainingSetupValidator
    {
        ...
        public static void ValidateTrainingSetup()
        {
            ...
            if (actions == null || actions.Length == 0) actions = Resources.LoadAll<CombatAction>("Combat/TestActions");
            if (actions != null && actions.Length > 0)
            {
                report.AppendLine($"✓ Found {actions.Length} actions in Resources/Combat");
